...
Writing a plugin for TileMill is a great way to add features or additional functionality you'd like to see. If you have a good understanding of how [Backbone](http://backbonejs.org) works you're well primed to start authoring your own. Before I jump into a quick primer on the basics let's dive into TileMill.
...
Plugins that provide additional functionality to TileMill's native interface you want to extend native code - not duplicate it. Have a look at how my `views/Datasource.js` file looks:
